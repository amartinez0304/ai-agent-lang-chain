...
class Workflow:
    def __init__(self):
        ...
        self.promts = DeveloperToolsPrompts()
    ...
    def _extract_tools_step(self, state: ResearchState) -> Dict[str,Any]:
        ...
        messages = [
            SystemMessage(content=self.promts.TOOL_EXTRACTION_SYSTEM),
            HumanMessage(content=self.promts.tool_extraction_user(state.query, all_content))        
        ]
    ...
    def _analyze_company_content(self, company_name:str, content:str) -> CompanyAnalysis:
        ...
        messages = [
            SystemMessage(content=self.promts.TOOL_ANALYSIS_SYSTEM),
            HumanMessage(content=self.promts.tool_analysis_user(company_name, content))
        ]
